...
### 13. Hermès Warmth (经典暖调)

**Vibe:** Luxurious, timeless, sophisticated, heritage

**Layout:** Cream paper card on soft background. Minimal, elegant typography.

**Typography:**
- Display: `Playfair Display` (700/900) — classic serif
...
:root {
    --bg-paper: #f2efe9;
    --text-ink: #1a1a1a;
    --accent-orange: #d95e00;
    --text-secondary: #4a4a4a;
}
```

**Signature Elements:**
- Generous whitespace on cream background
- Hermès orange as single confident accent
- Thin serif typography with elegant tracking
- Minimal decoration—quality speaks for itself

---

### 14. Klein Classic (经典冷调)

**Vibe:** Intellectual, precise, artistic, confident

**Layout:** Cream paper with Klein Blue accent. Clean editorial structure.

**Typography:**
- Display: `Libre Baskerville` (700) — refined serif
...
**Signature Elements:**
- Klein Blue as bold accent color
- Classic editorial layout with modern spacing
- Blue borders, underlines, or callout boxes
...
**Vibe:** Bold, artistic, gallery-like, statement-making

**Layout:** Full Klein Blue background. White text. Maximum contrast.

**Typography:**
- Display: `Bebas Neue` (400) — bold sans
...
**Signature Elements:**
- Klein Blue as dominant background (not accent)
- White text for maximum contrast
- Black geometric shapes as auxiliary elements
- Gallery-style spacing and typography
- Minimal content per slide—art speaks loud
...
| Hermès Warmth | Playfair Display | Source Sans 3 | Google |
| Klein Classic | Libre Baskerville | Libre Franklin | Google |
| Klein Art | Bebas Neue | Work Sans | Google |
